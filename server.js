...
io.on('connection', function (socket) {
  ...
  socket.on('answerquestion', function (answerdata) {
    ...
    // incorrectAnswers = answerdata.incorrectAnswers;
    // usersCorrect.push(answerdata.usersCorrect);
    // usersIncorrect.push(answerdata.usersIncorrect);
    // totalAnswers = answerdata.totalAnswers;
